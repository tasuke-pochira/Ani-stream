...
# 1.6. Inject Icon into EXE using rcedit
Write-Host "1.6. Injecting icon into EXE..."
$rceditPath = "$PSScriptRoot\..\scripts\rcedit.exe"
...
& $rceditPath "dist/AniStream.exe" --set-icon "assets/fox_mask.ico"

Write-Host "2. Self-signing the executable..."
Start-Sleep -Seconds 3  # Wait for pkg to fully release the file
