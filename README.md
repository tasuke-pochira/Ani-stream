...
A portable, zero-dependency anime streaming desktop app for Windows. Track your anime with MyAnimeList, stream in MPV, and manage your watchlist — all from one app.
